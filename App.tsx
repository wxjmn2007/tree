  ...
  return (
    <div className="relative w-full h-screen bg-black">
      ...
      <Canvas
        ...
        gl={{ 
          antialias: false, // Postprocessing handles AA better usually, or we turn it off for perf with Bloom
      ...
      <div className="absolute top-0 left-0 w-full h-full pointer-events-none flex flex-col justify-between p-8 z-10">
        ...
        <div className="text-center mt-4">
          <h1 className="font-luxury text-4xl md:text-6xl text-transparent bg-clip-text bg-gradient-to-b from-yellow-200 via-yellow-400 to-yellow-700 drop-shadow-lg tracking-widest">
            THE GRAND HOLIDAY
          </h1>
          <p className="font-serif-luxury text-yellow-100/60 text-sm md:text-lg mt-2 tracking-widest uppercase">
        ...
        <div className="mb-12 flex flex-col items-center gap-4 pointer-events-auto">
          <button
            ...
            className={`
              ...
              hover:border-yellow-300 hover:shadow-[0_0_30px_rgba(253,224,71,0.3)]
            `}
          >
            ...
            <div className="absolute inset-0 bg-yellow-400/10 translate-y-full group-hover:translate-y-0 transition-transform duration-500 ease-in-out" />
          </button>
